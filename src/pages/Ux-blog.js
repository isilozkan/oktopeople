                ...
                <div className='flex flex-wrap lg:flex-nowrap items-center'>
                  <div className='w-full lg:w-auto px-4 mb-8 lg:mb-0'>
                    <img
                      ...
                      src='saturn-assets/images/blog/image-blog-small-2.png'
                      alt=''
                    />
                  </div>
                  <div className='w-full lg:w-9/12 px-4 mb-10 lg:mb-0'>
                    <div className='max-w-2xl'>
                      ...
                      <p className='text-2xl font-semibold text-gray-900'>
                        {' '}
                        Web3 and User-Centric Design
                      </p>
                    </div>
                  </div>
                  <div className='w-full lg:w-auto px-4 ml-auto text-right'>
                    <a
                      className='inline-flex items-center text-xl font-semibold text-orange-900 hover:text-gray-900'
                      href='ux-blog-detail.html'
                    >
              ...
              <div className='py-12 border-t-2 border-gray-100'>
                <div className='flex flex-wrap lg:flex-nowrap items-center'>
                  <div className='w-full lg:w-auto px-4 mb-8 lg:mb-0'>
                    <img
                      className='block w-44 h-30'
                      src='saturn-assets/images/blog/image-blog-small-3.png'
                      alt=''
                    />
                  </div>
                  <div className='w-full lg:w-9/12 px-4 mb-10 lg:mb-0'>
                  ...
                  <div className='w-full lg:w-auto px-4 ml-auto text-right'>
                    <a
                      className='inline-flex items-center text-xl font-semibold text-orange-900 hover:text-gray-900'
                      href='ux-blog-generative_ai_and_personalized_experiences.html'
                    >
                      <span className='mr-2'>Read</span>
                      <svg
                        className='animate-bounce'
              ...
              <div className='py-12 border-t-2 border-gray-100'>
                <div className='flex flex-wrap lg:flex-nowrap items-center'>
                  <div className='w-full lg:w-auto px-4 mb-8 lg:mb-0'>
                    <img
                      className='block w-44 h-30'
                      src='saturn-assets/images/blog/image-blog-small-1.png'
                      alt=''
                    />
                  </div>
                  <div className='w-full lg:w-9/12 px-4 mb-10 lg:mb-0'>
                    <div className='max-w-2xl'>
                      ...
                      <p className='text-2xl font-semibold text-gray-900'>
                        Navigating Challenges in Web3 and Generative AI
                      </p>
                    </div>
                  </div>
                  <div className='w-full lg:w-auto px-4 ml-auto text-right'>
