  ...
  return (
    <React.Fragment>
      ...
      <>
        ...
        <div id='image-container' className='container mx-auto'>
          <img
            className='lazy-load'
            src='images/case-study1-p.svg'
            alt='Image 1'
          />
          <img
            className='lazy-load'
        ...
        <section className='relative pt-20 pb-20 lg:pb-32 overflow-hidden border-dotted'>
          <img
              ...
              <div className='flex flex-wrap -mx-4'>
                ...
                <div className='w-full lg:w-1/3 px-4 mb-12 lg:mb-0'>
                  <div>
                    <img
                      className='block mb-6 w-full h-100'
                      src='images/case-study-successrates.svg'
                      alt=''
                    />
                    <div>
                      <h3 className='text-3xl font-semibold mb-5'>
        ...
        <section className='relative py-20 lg:pt-32 lg:pb-36 bg-gray-50 overflow-hidden'>
          <img
            className='absolute bottom-0 right-0 -mb-20 md:-mb-0 -mr-40'
            src='saturn-assets/images/testimonials/circle-star-bg.svg'
            alt=''
          />
          <div className='relative container px-4 mx-auto'>
